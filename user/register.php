...
<head>
    ...
    <title>Register |  Automated Online Birth & Death Registration System</title>
                                    ...
                                    <div class="row">
                                        <div class="col-lg-12">
                                            <div class="login-title">
                                                <h1 style="color: #03a9f4; font-weight:600; text-align:center; ">User Registration</h1>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-8">
                                            <div class="login-button-pro">
                                                ...
                                                <button type="submit" class="login-button login-button-lg" name="submit"><a style="color: #fff;" href="login.php">Register</a></button>
                                            </div>
                                        </div>
                                    </div>
                                </div>
