                            ...
                            <div class="sparkline13-list shadow-reset">
                                ...
                                <div class="sparkline13-graph">
                                    ...
                                    <div class="datatable-dashv1-list custom-datatable-overright">
                                        <h3 style="text-align: center; color:#03a9f4;">Certificate of Birth</h3>
                                        <hr />
                                        <p align="center">This is a copy of the Birth & Death Certificate to be given.</p>
...
<strong > Application Number:</strong>   <?php  echo $row->ApplicationID;?></td></tr>
  ...
  <?php }?>
          ...
          <p align="center"><b>Certificate Date:</b> <?php echo htmlentities($certgendate);?></p>
