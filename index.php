...
<head>
    ...
    <title>Home Page |  Automated Online Birth & Death Registration System</title>
...
<body>
            ...
            <div class="row h-100">
                <div class="col-12 h-100">
                    <nav class="h-100 navbar navbar-expand-lg align-items-center">
                        <a class="navbar-brand" href="index.php"> Automated Online Birth & Death Registration System</a>
    ...
    <!-- ***** Hero Area Start ***** -->
    <div class="fancy-hero-area bg-img bg-overlay animated-img" style="background-image: url(img/bg-img/b2.jpg);">
                  ...
                  <div class="col-12 h-100">
                      <div class="copywrite-content h-100 d-flex align-items-center justify-content-between">
                          ...
                          <div class="copywrite-text">
                              <p style="color: #fff;">
Copyright &copy;<script>document.write(new Date().getFullYear());</script> Automated Online Birth & Death Registration System
</p>
                          </div>
                      </div>
                  </div>
